...
class TowerOfHanoi
  ...
  def play
    ...
    puts "Instructions:"
    print "Enter where you would like to move a disk from (either rod number 1, 2 or 3). "
    print "Then enter where you would like to move that disk to (either rod number 1, 2, or 3). "
    print "You can only move one disc at a time and you cannot place a larger disc on top of a smaller one. "
